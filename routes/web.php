...
// Approval routes
Route::get('/approbation-waiting', function () {
    return view('approbation-waiting');
})->name('approbation-waiting');

Route::get('/approval/pending-users', [ApprovalController::class, 'getPendingUsers'])->name('approval.pending-users');
Route::post('/approval/approve-user', [ApprovalController::class, 'approveUser'])->name('approval.approve-user');
Route::get('/approval/all-users-status', [ApprovalController::class, 'getAllUsersStatus'])->name('approval.all-users-status');